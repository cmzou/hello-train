...
1. Inky Impression [dimensional drawing](https://shop.pimoroni.com/en-us/products/inky-impression-4?variant=39599238807635)
...
1. Route names (for buses) can be retrieved from https://www.ctabustracker.com/bustime/api/v3/getroutes endpoint.
